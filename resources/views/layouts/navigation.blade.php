            ...
            <div class="flex w-full">
                ...
                @elseif(auth()->user())
                    ...
                    <div class="ml-auto flex items-center">
                        <a href="{{ route('cart.index') }}" class="inline-flex items-center text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Cart
        ...
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user() && auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.products.index')"
                                       :active="request()->routeIs('admin.products.*')">
                    {{ __('Products') }}admin.products.destroy
                </x-responsive-nav-link>
            @elseif(auth()->user())
